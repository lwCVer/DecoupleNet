...
class LoveDATrainDataset(Dataset):
    def __init__(self, data_root='/dataset/seg/LoveDA/trainval', img_dir='images_png', mosaic_ratio=0.25,
...
loveda_val_dataset = LoveDATrainDataset(data_root='/dataset/seg/LoveDA/Val', mosaic_ratio=0.0,
                                        transform=val_aug)


class LoveDATestDataset(Dataset):
    def __init__(self, data_root='/dataset/seg/LoveDA/Test', img_dir='images_png',
