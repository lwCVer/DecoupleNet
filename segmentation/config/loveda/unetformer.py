...
weights_name = "unetformer-r18-512crop-ms-epoch100-rep"
...
train_dataset = LoveDATrainDataset(transform=train_aug,
                                   data_root='/mnt/disk2/lw/dataset/segmengation/LoveDA/trainval')

val_dataset = LoveDATrainDataset(data_root='/mnt/disk2/lw/dataset/segmengation/LoveDA/Val',
                                 mosaic_ratio=0.0,
                                 transform=val_aug)
