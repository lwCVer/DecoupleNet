...
class MRLA(nn.Module):
    def __init__(self, channel, att_kernel, norm_layer):
        ...
        self.primary_conv = nn.Sequential(
            ...
            build_norm_layer(norm_layer, channels12)[1],
            nn.GELU(),
        )
        ...
        self.batchnorm = build_norm_layer(norm_layer, channel)[1]
...
class MBFD(nn.Module):
    ...
    def __init__(self, dim, stage, att_kernel, norm_layer):
        ...
        if stage > 2:
            ...
            self.norm = build_norm_layer(norm_layer, self.dim_untouched)[1]
        ...
        if self.fork_feat:
            ...
            for i_emb, i_layer in enumerate(self.out_indices):
                if i_emb == 0 and os.environ.get('FORK_LAST3', None):
                    ...
                    layer = build_norm_layer(norm_layer, int(embed_dim * 2 ** i_emb))[1]
